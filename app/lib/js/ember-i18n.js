/**
 * Following code is taken for github project jamesarosen/ember-i18n
 * link https://github.com/jamesarosen/ember-i18n/blob/master/lib/i18n.js
 *
 *
 * CHANGES ADDED TO CODE
 * CHANGE 1:   Removal of default span tag that is being added for all i18n messages if no tag name attribute is passed.
 */
...
(function(window) {
    ...
    Handlebars.registerHelper('t', function(key, options) {
        ...
        data = options.data;
        view = data.view;
        tagName = attrs.tagName;// CHANGE #1, it used to have || 'span';
        ...
        Em.keys(attrs).forEach(function(property) {
            ...
            if (isBindingMatch) {
                if(!tagName) tagName = 'span'; // CHANGE #1
